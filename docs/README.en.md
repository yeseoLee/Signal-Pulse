...
- Signal and function map: [`signals.md`](./signals.md)
...
This repository shares a rule-based automation workflow and its implementation approach.
It is not intended as investment advice, solicitation, or a source of guaranteed signals.
You are solely responsible for any execution or use of this project.
